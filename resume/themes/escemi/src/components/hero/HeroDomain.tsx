...
import ContactInlineList from "./ContactInlineList.jsx";
import MetricBar from "./MetricBar.jsx";
import { sanitize, displayUrl } from "../../utils/resumeHelpers.js";
...
const HeroDomain = ({ basics, summary, metrics }: HeroDomainProps) => {
  ...
  return (
    <div className="glow-panel px-4 py-4 space-y-2.5">
